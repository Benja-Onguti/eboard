...
export const features: Feature[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Live document editing, annotations, and discussions during meetings',
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Role-based permissions at folder and document level with granular controls',
      },
      {
      ...
      },
      {
        ...
        description: 'Password-protected links with expiration dates and view-only access',
      },
    ],
    audience: ['education', 'government', 'ngo', 'corporate'],
  },
    ...
    features: [
      {
        ...
        description: 'Save hours with auto-generated minutes that adapt to your agenda structure',
      },
      {
      ...
      },
      {
        ...
        description: 'Record important meetings to preserve institutional knowledge',
      },
      {
        title: 'Key Takeaways',
        description: 'AI automatically extracts decisions, action items, and key discussion points',
      },
    ],
    audience: ['education', 'government', 'ngo', 'corporate'],
  },
    ...
    features: [
      {
        ...
        description: 'Create transparent public records of all board meetings and decisions',
      },
      {
        title: 'FOI Compliance',
        description: 'Meet freedom of information requirements with automated record keeping',
      },
      {
      ...
      },
      {
        ...
        description: 'Easily redact sensitive information before public publishing',
      },
    ],
