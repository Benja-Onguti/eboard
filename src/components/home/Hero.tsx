        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl">
              Reimagine how your board leads—with clarity, confidence, and
              purpose. Streamline meetings, enhance security, and drive better
              decisions across your organization [citation:2].
            </p>
